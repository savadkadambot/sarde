                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" method="POST" action="">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="" name="job_code" placeholder="Job Code">
                    </div>
                     <div class="form-group">
                      <label for="">Job Heading</label>
                      <input type="number" class="form-control" id="" name="job_heading" placeholder="Job Heading">
                    </div>
                    <div class="form-group">
                      <label for="">Job Description</label>
                      <textarea class="form-control" name="job_description" cols="30" rows="10" required=""></textarea>
                      <!-- <input type="number" class="form-control" id="" name="job_description" placeholder="Job Description"> -->
                    </div>
                   
                    <div class="form-group">
                      <label for="">Start Date</label>
                      <input type="text" class="form-control" id="" name="start_date" placeholder="Start Date">
                    </div>
                    <div class="form-group">
                      <label for="">Finish Date</label>
                      <input type="text" class="form-control" id="" name="finish_date" placeholder="Finish Date">
                    </div>
                    <div class="form-group">
                      <label for="">Road Marking sqm</label>
                      <input type="text" class="form-control" id="" name="road_marking_sqm" placeholder="Road Marking sqm">
                    </div>
                     <div class="form-group">
                      <label for="">Stud Fixing Nos</label>
                      <input type="number" class="form-control" id="" name="stud_fixing_nos" placeholder="Stud Fixing Nos">
                    </div>
                    <div class="form-group">
                      <label for="">Board Fixing Nos</label>
                      <input type="text" class="form-control" >
                    </div>
                      <div class="form-group">
                      <label for="">Created Date</label>
                      <input type="text" class="form-control" id="" name="board_fixing_nos" placeholder="Board Fixing Nos">
                    </div>

                     <a class="btn btn-primary btn-sm" href="<?php echo base_url(); ?>index.php/API/Jobs/view_job/<?php echo $row['id']; ?>">
