                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" method="POST" action="">
                     ...
                     <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="" name="job_title" placeholder="Job Heading" required>
                    </div>
                    <div class="form-group">
                   ...
                   <!--  <div class="form-group">
                      <label for="">Road Marking Square metre</label>
                      <input type="text" class="form-control" id="" name="road_marking_sqm" placeholder="Road Marking Square metre" required>
                    </div>
                    <div class="form-group">
                      <label for="">Stud Fixing Numbers</label>
                      <input type="text" class="form-control" id="" name="stud_fixing_nos" placeholder="Stud Fixing Numbers" required>
                    </div>
                    <div class="form-group">
                      <label for="">Board Fixing Numbers</label>
                      <input type="text" class="form-control" id="" name="board_fixing_nos" placeholder="Board Fixing Numbers" required>
                    </div> -->
                    <br>
