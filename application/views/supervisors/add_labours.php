                ...
                ?>
                  ...
                  <form class="forms-sample" method="POST" action="">
                    <div class="form-group">
                     ...
                     <div class="form-group">
                      <label>Mobile</label>
                      <input type="text" class="form-control" name="mobile" placeholder="Mobile no" required="" value="<?php echo $mobile; ?>">
                    </div>

                    <div class="form-group">
                      <label>Trade</label>
                      <input type="text" class="form-control" name="trade" placeholder="Trade" required="" value="<?php echo $trade; ?>">
                    </div>
