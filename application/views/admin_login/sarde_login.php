...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url(); ?>new/vendors/ti-icons/css/themify-icons.css">
  <link rel="stylesheet" href="<?php echo base_url(); ?>new/vendors/css/vendor.bundle.base.css">
  <!-- endinject -->
          ...
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              <div class="brand-logo">
                <!--<h1>SarDe</h1>-->
               <img src="<?php echo base_url(); ?>/newtheme/images/aklogo.png" alt="logo" style="margin-left: 27%; "/>
